 "SIMLR_Estimate_Clusters_W" = function( W, NUMC = 2:5, cores.ratio = 1 ) {
 ...
 # compute and returns the multiple kernel
  "multiple.kernel.numc.sqrt" = function( x, cores.ratio = 1 ) {
    ...
    Diff = ((dist2(x))^2)^0.25   ##I revised here to 1/2
